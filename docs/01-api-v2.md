...
```json
{
  ...
  "links": {
    ...
    "photos": "/api/albums/kochi-2025/photos",
    "cover": "/media/photos/x7KpQ2mL9a/thumb"
  }
}
```
  ...
  "albums": [
    {
      ...
      "links": {
        ...
        "photos": "/api/albums/year-2025/photos",
        "cover": "/media/photos/x7KpQ2mL9a/thumb"
      }
    }
  ],
...
```json
{
  ...
  "favorite": false,
  "links": {
    "self": "/api/photos/x7KpQ2mL9a",
    "thumb": "/media/photos/x7KpQ2mL9a/thumb",
    "preview": "/media/photos/x7KpQ2mL9a/preview",
    "original": "/media/photos/x7KpQ2mL9a/original"
  }
}
```
...
MVP では，写真詳細 API を使わず，`GET /api/albums/{album_id}/photos` のレスポンスだけで写真グリッドと簡易プレビューを作ってもよいです．
...
`GET /api/photos/{photo_id}` は，写真詳細モーダルを本格的に作る段階まで後回しでよいです．
...
Photo.tags
GET /api/albums?tag=...
GET /api/albums/{album_id}/photos?tag=...
TagsResponse
```
