...
| Name        | tag        | accent  | accent-soft |
| ----------- | ---------- | ------- | ----------- |
| Sakura Pink | `pink`     | #FF6FAE | #FFE3EF     |
| Coral Pop   | `coral`    | #FF6B5F | #FFE6E2     |
| Mint Fresh  | `mint`     | #35C99B | #DFF8EF     |
| Sky Blue    | `blue`     | #4DA3FF | #E3F1FF     |
| Lavender    | `lavender` | #9B7CFF | #EEE8FF     |
| Lemon       | `lemon`    | #F4C430 | #FFF5C7     |
| Tomato Red  | `red`      | #F04438 | #FFE4E0     |
| Warm Beige  | `beige`    | #C88A5A | #F4E8DD     |
```
